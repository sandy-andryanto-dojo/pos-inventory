        ...
        <div class="box-body">
            <form class="form-horizontal">
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <p class ="form-control-static">{{ CommonHelper::getVal($model, 'username') }}</p>
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    <label for="" class="col-sm-2 control-label">Confirmed :</label>
                    <div class="col-sm-10">
                        <p class ="form-control-static">
                            {!! (int) CommonHelper::getVal($model, 'is_confirm') == 1 ? '<span class="label label-success"> Yes</span></td>' : '<span class="label label-danger"> No</span></td>' !!}
                        </p>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <p class ="form-control-static">
                            {{ implode(",", $model->Roles->pluck("name")->toArray())  }}
                        </p>
                    </div>
                </div>
            </form>
