...
<form class="form-invoice">
    <div class="row">
        ...
        <div class="form-group col-md-3">
            ...
            {!! Form::select('supplier_id', $suppliers->pluck('name','id'), null, ['id'=>'supplier_id','class'=>'select2 form-control', 'placeholder'=> '--- Select Supplier ---']) !!}
        </div>
    </div>
    <div class="row">
        ...
        <div class="form-group col-md-3">
            ...
            <input type="text" class="form-control" id="discount" name="discount" min="0" value="{{ $model->discount }}" />
        </div>
        <div class="form-group col-md-3">
            <label for="">Total Tax</label>
            <input type="text" class="form-control" id="tax" name="tax" min="0"  value="{{ $model->tax }}" />
        </div>
        <div class="form-group col-md-3">
